...
const mapDispatchToProps = {userAuthenticate};
...
class HeaderPrimary extends React.Component {
  ...
  logOut = () => fireAuth.signOut().then((/*user, error*/) => {
...
export default connect(mapStateToProps, mapDispatchToProps)(withStyles(styles)(HeaderPrimary));